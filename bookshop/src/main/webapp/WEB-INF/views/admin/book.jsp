	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/b" method="POST" modelAttribute="book">
				<custom:hiddenInputs excludeParams="bookname"/>
					...
					<div class="form-group">
  					...
  					<div class="form-group">
						<label for="name" class="col-sm-offset-2 col-sm-10"><form:errors path="bookYear"/></label>
					</div>
  					<div class="form-group">
    					<label for="name" class="col-sm-2 control-label">Book year</label>
    					<div class="col-sm-10">
      						<form:input class="form-control" path="bookYear" id="name"/>
    					</div>
  					</div>
  					<div class="form-group">
						<label for="name" class="col-sm-offset-2 col-sm-10"><form:errors path="bookPages"/></label>
					</div>
  					<div class="form-group">
    					<label for="name" class="col-sm-2 control-label">Book pages</label>
    					<div class="col-sm-10">
      						<form:input class="form-control" path="bookPages" id="name"/>
    					</div>
  					</div>
  					<div class="form-group">
						<label for="name" class="col-sm-offset-2 col-sm-10"><form:errors path="bookPrice"/></label>
					</div>
  					<div class="form-group">
    					<label for="name" class="col-sm-2 control-label">Book price</label>
    					<div class="col-sm-10">
			...
			<div class="col-md-6 col-xs-6 text-center">
				<div class="dropdown">
					...
					<ul class="dropdown-menu">
						<custom:sort innerHtml="Name asc" paramValue="book"/>
						<custom:sort innerHtml="Name desc" paramValue="book,desc"/>
					</ul>
				</div>
			</div>
			<div class="col-md-6 col-xs-6 text-center">
