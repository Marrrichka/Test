...
<div class="col-md-3 col-xs-12">
	...
	<div class="col-md-7 col-xs-12">
		...
		<div class="row">
			<div class="col-md-4 col-xs-4"><h3>Book Topic`s Category name</h3></div>
			<div class="col-md-4 col-xs-4"><h3>Update</h3></div>
			<div class="col-md-4 col-xs-4"><h3>Delete</h3></div>
		</div>
			<c:forEach items="${page.content}" var="booktpc">
				<div class="row">
					<div class="col-md-4 col-xs-4">${booktpc.booktpc}</div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/btpc/update/${booktpc.id}<custom:allParams/>">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/btpc/delete/${booktpc.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
